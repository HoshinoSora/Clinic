...
CREATE TABLE `token` (
  ...
  KEY `memberId_idx` (`doctorId`),
  CONSTRAINT `memberId` FOREIGN KEY (`doctorId`) REFERENCES `member` (`memberId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- Dump completed on 2018-03-14 21:59:44
